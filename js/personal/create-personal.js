...
(function () {
    ...
    var TEXT = ['“Очень здорово, когда ты что-то даешь людям ”.', 'Дайте работу', 'Каждой работе человек должен научиться сам.', 'Поменьше грез, рожденных скукою,побольше дела и труда!'];
